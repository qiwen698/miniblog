...
import (
	...
	"github.com/qiwen698/miniblog/pkg/version"
...
// String 实现了pflag.Value接口中的String方法
...
// Type 实现了 pflag.Value 接口中的Type 方法
...
// AddFlags 在任意 FlagSet 上注册这个包的标志，这样他们指向与全局标志相同的值
